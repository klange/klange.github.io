...
var Module = {
  preRun: [function() {
    ...
    FS.createPreloadedFile('/usr/local/lib/kuroko/syntax', '__init__.krk', 'syntax/__init__.krk', 1, 0)
    FS.createPreloadedFile('/usr/local/lib/kuroko/syntax', 'highlighter.krk', 'syntax/highlighter.krk', 1, 0)
    FS.createPreloadedFile('/usr/local/lib/kuroko/foo', '__init__.krk', 'syntax/__init__.krk', 1, 0)
    FS.createPreloadedFile('/usr/local/lib/kuroko/foo/bar', '__init__.krk', 'syntax/__init__.krk', 1, 0)
